...
#      (lang-fr, lang-de, lang-es-ES, lang-ca, lang-eu, lang-yua, lang-it, lang-pl, lang-nl, lang-ko, lang-nah) — the contract from
...
LANG_CODES=(fr de es-ES ca eu yua it pl nl ko nah)
