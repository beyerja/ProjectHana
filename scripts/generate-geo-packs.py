...
For each downloadable (non-base) language — fr, de, es-ES, ko, nah — this emits a
...
PACK_LANGUAGES = ["fr", "de", "es-ES", "ko", "nah"]

# Map an AppLocale code to the JSON field suffix used in the bundled source data.
SUFFIX_BY_CODE = {"fr": "fr", "de": "de", "es-ES": "es_es", "ko": "ko", "nah": "nah"}
