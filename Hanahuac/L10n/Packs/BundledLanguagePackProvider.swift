...
struct BundledLanguagePackProvider: LanguagePackProvider {
    ...
    ///
    /// Only the per-language translation columns (fr/de/es-MX/es-ES/ca/eu/yua/ko/nah/ja/zh-Hans) become
    ...
    private static func buildPacks(from geography: GeographyData) -> [String: GeoNamePackData] {
        let packLanguages: [AppLocale] = [.fr, .de, .esMX, .esES, .ca, .eu, .yua, .ko, .nah, .ja, .zhHans]
